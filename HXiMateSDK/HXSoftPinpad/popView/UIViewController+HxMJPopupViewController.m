...
#import "HxMJPopupBackgroundView.h"
...
- (void)dismissPopupViewControllerWithanimationType:(HxMJPopupViewAnimation)animationType
{
    ...
    if(animationType == HxMJPopupViewAnimationSlideBottomTop || animationType == HxMJPopupViewAnimationSlideBottomBottom || animationType == HxMJPopupViewAnimationSlideRightLeft) {
...
- (void)presentPopupView:(UIView*)popupView animationType:(HxMJPopupViewAnimation)animationType
{
    UIView *sourceView = [self topView];
    ...
    // BackgroundView
    HxMJPopupBackgroundView *backgroundView = [[HxMJPopupBackgroundView alloc] initWithFrame:sourceView.bounds];
    ...
    if(animationType == HxMJPopupViewAnimationSlideBottomTop) {
    ...
    } else if (animationType == HxMJPopupViewAnimationSlideRightLeft) {
        ...
        [self slideViewIn:popupView sourceView:sourceView overlayView:overlayView withAnimationType:animationType];
    } else if (animationType == HxMJPopupViewAnimationSlideBottomBottom) {
...
{
    [self dismissPopupViewControllerWithanimationType:HxMJPopupViewAnimationSlideBottomTop];
}

- (void)dismissPopupViewControllerWithanimationTypeSlideBottomBottom
{
    [self dismissPopupViewControllerWithanimationType:HxMJPopupViewAnimationSlideBottomBottom];
}

- (void)dismissPopupViewControllerWithanimationTypeSlideRightLeft
{
    [self dismissPopupViewControllerWithanimationType:HxMJPopupViewAnimationSlideRightLeft];
}
...
- (void)slideViewIn:(UIView*)popupView sourceView:(UIView*)sourceView overlayView:(UIView*)overlayView withAnimationType:(HxMJPopupViewAnimation)animationType
{
    ...
    if(animationType == HxMJPopupViewAnimationSlideBottomTop || animationType == HxMJPopupViewAnimationSlideBottomBottom) {
...
- (void)slideViewOut:(UIView*)popupView sourceView:(UIView*)sourceView overlayView:(UIView*)overlayView withAnimationType:(HxMJPopupViewAnimation)animationType
{
    UIView *backgroundView = [overlayView viewWithTag:kMJBackgroundViewTag];
    // Generating Start and Stop Positions
    CGSize sourceSize = sourceView.bounds.size;
