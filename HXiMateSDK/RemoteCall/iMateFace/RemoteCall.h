...
#define FUNC_uiEsamGetCardRandom			9802	//(uint uiRandLen, uchar *psRandom)
#define FUNC_uiEsamExternalAuth				9803	//(uchar ucMasterKeyId, uchar *psAuthData)
#define FUNC_uiEsamReloadKey				9804	//(uchar *psInData)
#define FUNC_uiEsamDownloadMasterKey		9805	//(uint uiDataType, uint uiMasterKeyIndex, uchar *psMasterKey, uint uiKeyLen)
#define FUNC_uiEsamDownloadWorkingKey		9806	//(uint uiDataType, uint uiMasterKeyIndex, uint uiWorkingKeyIndex, uchar *psWorkingKey, uint uiKeyLen)
#define FUNC_uiEsamCalPinBlock				9807	//(uint uiDataType, char *pszCardNo, uint uiMasterKeyIndex, uint uiWorkingKeyIndex, uchar *psPin, uint uiPinLen, uchar *psPinBlock)
#define FUNC_uiEsamMasterKeyEncrypt			9808	//(uint uiAlgo, uint uiMasterKeyIndex, uint uiEncryptMode, uchar *psInData, uint uiInDataLen, uchar *psOutData)
#define FUNC_uiEsamWorkingKeyEncrypt		9809	//(uint uiAlgo, uint uiMasterKeyIndex, uint uiWorkingKeyIndex, uint uiEncryptMode, uchar *psInData, uint uiInDataLen, uchar *psOutData)

#define FUNC_uiPboc20CustomApdu				9901	//(uint uiReader, uchar *psApduIn, uint uiInLen, uchar *psApduOut, uint *puiOutLen)
#define FUNC_vSetIccFreq                    9902	//(uint uiFrequency)
