...
//extern int  iIMateTestCard(void);
//extern int  iIMateResetCard(uchar *psResetData);
//extern int  iIMateCloseCard(void);
//extern int  iIMateExchangeApdu(int iInLen, uchar *pIn, int *piOutLen, uchar *pOut);
